 ...
 */
export declare const useBem: <ModifierKey extends string, Prefix extends string>(prefix: Prefix, modifiers: Record<ModifierKey, boolean> | Ref<Record<ModifierKey, boolean>> | (() => Record<ModifierKey, boolean>)) => ComputedClasses<`${Prefix}--${ModifierKey}`>;
export {};
